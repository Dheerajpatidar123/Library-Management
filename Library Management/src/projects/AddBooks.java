		...
		btnAddBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if( book_id1==(int) book_id1) {
					if ( book_id.equals("") || name.equals("") || author.getText().equals("")) {
						
						ClassNameHere.infoBox("Plese Enter All Book Details", "TITLE BAR MESSAGE");
					}
					else {
					
					String qr2 = "INSERT INTO addbook" + "( book_id, book_name,author) VALUES" + "(?,?,?)";
					PreparedStatement ps1 = conn.prepareStatement(qr2);
					ps1.setInt(1,  book_id1);
					...
					ClassNameHere.infoBox("Book Added", "TITLE BAR MESSAGE");
						...
						ClassNameHere.infoBox("Plese Enter Book ID in Numric Format", "TITLE BAR MESSAGE");
						}
					...
					n.printStackTrace();
					ClassNameHere.infoBox("Please Enter Valid Book ID", "TITLE BAR MESSAGE");
					setVisible(false);
	            	dispose();
					AddBooks frame = new AddBooks();
					frame.setVisible(true);
					...
					e1.printStackTrace();
					ClassNameHere.infoBox("This Book Id is Already Exist", "TITLE BAR MESSAGE");
					setVisible(false);
	            	dispose();
					AddBooks frame = new AddBooks();
					frame.setVisible(true);
